...
#-----------------------------------------------------------------------------
vendor_saved_apps := KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
...
#-----------------------------------------------------------------------------
board_remove_apps := LogReport MzUpdate NetContactService Mms Music MusicFX
...
override_property += \
    ...
    ro.product.model_romer=ONE A2001_Unofficial
